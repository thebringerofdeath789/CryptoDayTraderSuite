...
namespace CryptoDayTraderSuite.UI
{
	public class TradingControl : UserControl
	{
		...
		private FlowLayoutPanel configPanel;
		...
		public TradingControl()
		{
			InitializeComponent();
			InitializeChart();
			SetStatus("Ready", warn: false, neutral: true);
		}
		...
		private void InitializeChart()
		{
			...
			if (chartHost != null)
			{
				...
				chartHost.Controls.Add(chartPanel);
			}
		}
		...
		{
			SetStatus(message, warn: false, neutral: false);
		}

		public void SetStatus(string message, bool warn, bool neutral)
		{
			if (lblTradeStatus != null)
			{
		...
		{
			SetStatus("Loading products", warn: false, neutral: true);
			this.LoadProductsClicked?.Invoke(this, EventArgs.Empty);
		}

		private void BtnFees_Click(object sender, EventArgs e)
		{
			SetStatus("Loading fees", warn: false, neutral: true);
			this.FeesClicked?.Invoke(this, EventArgs.Empty);
		}

		private void BtnBacktest_Click(object sender, EventArgs e)
		{
			SetStatus("Running backtest", warn: false, neutral: true);
			this.BacktestClicked?.Invoke(this, EventArgs.Empty);
		}

		private void BtnPaper_Click(object sender, EventArgs e)
		{
			SetStatus("Submitting paper trade", warn: false, neutral: true);
			this.PaperClicked?.Invoke(this, EventArgs.Empty);
		}

		private void BtnLive_Click(object sender, EventArgs e)
		{
			SetStatus("Submitting live trade", warn: false, neutral: true);
			this.LiveClicked?.Invoke(this, EventArgs.Empty);
		}
		...
		private void InitializeComponent()
		{
			...
			this.numRisk.Minimum = new decimal(new int[4] { 1, 0, 0, 0 });
			this.numRisk.Name = "numRisk";
			this.numRisk.Size = new System.Drawing.Size(120, 20);
			this.numRisk.TabIndex = 9;
			this.numRisk.Value = new decimal(new int[4] { 2, 0, 0, 0 });
			...
			base.Name = "TradingControl";
			base.Size = new System.Drawing.Size(900, 600);
